...
days = ['.نظم برای واقعی‌ات است', '.ساده برای واقعی‌ات است', '.آدم برای واقعی‌ات است', '.احترام برای واقعی‌ات است', '.صلح برای واقعی‌ات است', '.آزادی برای واقعی‌ات است', '.لذت برای واقعی‌ات است'];
