...
(function() {
  ...
  var months = ["در دلِ پاک", "از جیب موسی", "از جیب روسا", "از جیب یوسا", "از جیب خسیسا", "از جیب مسیرم",
  "در کشورم", "در جهانم", "در دنیایم", "در اطاقم", "در کنارم", "در حیاطم"
],
days = ['.نظم به واقعیت است', '.ساده به واقعیت است', '.آدم به واقعیت است', '.احترام به واقعیت است', '.صلح به واقعیت است', '.آزادی به واقعیت است', '.لذت به واقعیت است'];
